...
export async function GET() {
    ...
    const CLIENT_ID = process.env.DISCORD_CLIENT_ID; // Client ID / Application ID bot kamu
    ...
    // Daftarkan command khusus ke server (Guild Command agar langsung muncul tanpa delay)
