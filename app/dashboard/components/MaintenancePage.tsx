...
import { Gamepad2, Construction, Clock, Coffee } from 'lucide-react';
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-sm md:text-lg font-black uppercase italic mb-8">
                        Sistem dinonaktifkan sementara soalnya developer lagi sibuk banget nyooo (sibuk ngopi).<br/>Harap maklum ya! ✌️
                    </p>
                    ...
                    <div className="flex items-center justify-center gap-3 bg-black text-[#CCFF00] py-3 px-6 border-4 border-black font-black uppercase italic animate-pulse">
                        <Coffee size={20} /> STATUS: DEVELOPER AFK NYOOO
                    </div>
                </div>
            </motion.div>
        </div>
